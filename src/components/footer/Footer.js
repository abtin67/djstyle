  ...
  return (
    <>
      <footer className="py-3 mt-5">
        ...
        <Container>
          <Row className="row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-xl-4 m-y-3">
            <Col className="py-3">
              <h4>خرید</h4>
            ...
            <Col className="py-3">
              <h6>
                ...
                <NavLink
                  ...
                  to="tel:+98 9038308519"
                  target="_blank"
                >
                  <span>09038308519</span>
                </NavLink>
              </h6>
              <div className="media">
                <NavLink
                  ...
                  target="_blank"
                  className="nav-link"
                  to="https://www.instagram.com/frydoun67"
                >
          ...
          <span className="py-5">
            کلیه حقوق این سایت متعلق به <b>فریدون عاقبتی </b>می باشد
          </span>
        </Container>
      </footer>
    </>
